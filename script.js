...
let question2 = +prompt(`Кампания какой из рас идет первой? \n Варианты ответов: \n 1) Кампания Нежити \n 2) Кампания Орды \n 3) Кампания Ночных Эльфов \n Ответ запишите номером варианта.`);
if (question2 == 3) {
    allPoints = allPoints + 1;
}

let question3 = +prompt(`Какой новый юнит получила фракция нежити в Warcraft III: The Frozen Throne? \n Варианты ответов: \n 1) Обсидиановая статуя \n 2) Волшебный дракончик \n 3) Эльф крови \n Ответ запишите номером варианта.`);
if (question3 == 1) {
    allPoints = allPoints + 1;
}

let question4 = +prompt(`За какую из не игровых фракций можно поиграть в 8 главе Кампании Ночных Эльфов? Варианты ответов: 1) За кобальдов 2) За наг 3) За демонов Ответ запишите номером варианта.`);
if (question4 == 2) {
    allPoints = allPoints + 1;
}
